# Azure VM Lab – Terraform Walkthrough (Dylan's Project)

🎬 **Watch Me Build The Lab HERE:**  
[Loom Video](https://www.loom.com/share/0d61ee22ebba4e7b854ae1cd04fc1187)

## 🌐 Overview

This lab demonstrates how to deploy a **Windows Server 2022 VM** in Azure using **Terraform** and configure it as an **Active Directory Domain Controller**.  

It’s a full workflow from setup to cleanup using **Infrastructure as Code (IaC)**.
...
### 1️⃣ Project Setup
Created project folder and Terraform files in PowerShell:
...
Downloaded Terraform and added it to PATH. Verified installation:
...
Open Remote Desktop and log in:
